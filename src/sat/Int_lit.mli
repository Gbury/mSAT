...
(** SAT Formulas
    ...
    Atomic formuals are represented using integers, that should allow near
    optimal efficiency (both in terms of space and time). *)
...
(** [apply_sign b] is the identity if [b] is [true], and the negation function
    if [b] is [false]. *)
