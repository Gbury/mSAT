...
\tblock{Performances}
{
  ...
  \begin{tabular}{c|@{\,}c@{\,}|@{\,}c@{\,}|c|c}
    \begin{tabular}{c}solver\\{\small (package)}\end{tabular} & \begin{tabular}{c}Alt-ergo-zero\\{\small aez}\end{tabular} & \begin{tabular}{c}mSAT\\{\small msat}\end{tabular} & \begin{tabular}{c}minisat\\{\small (minisat/sattools)}\end{tabular} & \begin{tabular}{c}cryptominisat\\{\small (sattools)}\end{tabular} \\ \hline
